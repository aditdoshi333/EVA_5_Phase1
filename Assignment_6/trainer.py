...
class Training:
    ...
    def __init__(self, model, optimizer, train_loader, test_loader,device ,l1=0):
        self.model = model
    ...
    def train_every_epoch(self, epoch):
        ...
        for batch_idx, (data, target) in enumerate(pbar):
            ...
            if self.l1 > 0:
                l1_reg_loss = sum([torch.sum(abs(param)) for param in self.model.parameters()])

                loss = criterion + self.l1 * l1_reg_loss
            else:
                loss = criterion
